...
public class ScientistPrunamHarvester extends PrunamHarvester {
	...
	public static void loadImages() {
		...
		standImg = game.ImageHandler.load(path, "ScientistPrunamHarvester");
	}

	public ScientistPrunamHarvester(String[] c) {
		super(c);
